...
driver.get("https://www.rippletrade.com/#/register")
...
driver.find_element_by_xpath("//div[@id='t-register']/section/div[1]/div[2]/form/div[11]/a").click()
masterkey="ss..."
send_key("register_masterkey",masterkey)
